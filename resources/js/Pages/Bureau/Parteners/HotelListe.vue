<template>
    <div class="row mb-4">
        <div class="d-flex justify-content-between">
            <div class="">
                <h3>Liste des Hôtels & Résidences</h3>
            </div>
            <div class="">
                <a href="#" type="button" class="btn btn-primary">Ajouter Hotel / Résidence</a>
            </div>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <div id="datatable3_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="(hotel, index) in props.hotelListe.data" :key="index">
                                    <td>
                                        <div class="m-2">
                                            {{ index + 1 }}
                                        </div>
                                    ...
                                    <td>
                                        <div class="m-2">
                                            {{ truncate(hotel.address, 27) }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="m-2">
                                            <span class="badge badge-success badge-style-light"
                                                v-if="hotel.company_status == '1'">Actif</span>
                                            <span class="badge badge-warning badge-style-light"
                                                v-if="hotel.company_status == '2'">Inactif</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="m-2">
                                            <span v-if="hotel.company_type == '1'">Hôtel</span><span
                                                v-if="hotel.company_type == '2'">Résidence</span>
                                        </div>
                                    </td>
                                    <td>
                ...
                <div class="row">
                    ...
                    <!-- pagination -->
                    <Pagination :links="props.hotelListe.links" :next="props.hotelListe.next_page_url"
                        :prev="props.hotelListe.prev_page_url" />
                </div>
            </div>
        </div>
    </div>
...
const filtre_type = ref(props.filtres.filtre ?? "");
...
const search = _.throttle(function () {
    ...
    Inertia.get(route("hotel.bureau",
        ...
        // 3ème paramètre la reponse de mon controller
        {
            ...
            onError: () => {
                // je récupère le message d'erreur de mon controller
                // console.log(Inertia.page.props.errors.error)
            }
        }
